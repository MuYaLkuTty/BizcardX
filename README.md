...
This project is created with Python using easyOCR, streamlit, regular expressions, pandas, matplotlib, mysql libraries.
The link for the dashboard:http://localhost:8501/
