...
#Setting Page Configuations

icon = Image.open(r"E:\BizcardX\Home.jpeg")
...
#Setting up backgroung Image

def setting_bg():
    st.markdown(f'''<style>.stApp{{background:url('https://cutewallpaper.org/22/plane-colour-background-wallpapers/189265759.jpg');
...
selected = option_menu(None, ["Home","Upload & Extract","Modify","Contact"], 
                       icons=["house","cloud-upload","pencil-square","at"],
                       default_index=0,
                       orientation="horizontal",
                       styles={"nav-link": {"font-size": "35px", "text-align": "centre", "margin": "-2px", "--hover-color": "#6F36AD"},
...
if selected == "Contact":
    ...
    st.write("This project is created with Python using easyOCR, streamlit, regular expressions, pandas, matplotlib, mysql libraries.")
    st.write("---")
    st.write("#")
